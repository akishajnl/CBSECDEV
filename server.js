...
app.get('/tutor', requireAuth, (req, res) => {
    res.render('tutor-dashboard'); 
});

// Secure Admin Dashboard GET 
app.get('/admin', requireRole('Administrator'), async (req, res) => {
    try {
...
app.post('/admin/promote', requireRole('Administrator'), async (req, res) => {
    try {
...
app.post('/admin/logs/clear', requireRole('Administrator'), async (req, res) => {
    try {
...
app.get('/profile/security', requireAuth, async (req, res) => {
    try {
...
app.get('/profile/security/verify-prompt', requireAuth, async (req, res) => {
    try {
        const user = await User.findById(req.session.userId);
